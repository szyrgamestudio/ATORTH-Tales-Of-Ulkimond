...
(function() {
    ...
    var descriptionList = {
        ...
        'item': ["", "\\I[2756]Zobacz posiadane przedmioty."],
        'skill': ["", "\\I[2768]Zobacz umiejętności postaci."],
        'equip': ["", "\\I[2750]Zmień wyposażenie gracza."],
        'status': ["", "\\I[2770]Zobacz statystyki bohaterów."],
        'formation': ["", "\\I[2747]Zmień formacje drużyny."],
        'options': ["", "\\I[2771]Ustawienia Gry."],
        'save': ["", "\\I[2766]Zapisz."],
        'gameEnd': ["", "\\I[2751]Wyjdź z gry."],
        'quest': ["", "\\I[2747]Zobacz questy."],
        'achievements': ["", "\\I[868]Zobacz osiągnięcia."]
    };
    /* --------------------------------------------------------------------------------
