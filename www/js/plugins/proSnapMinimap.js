...
(() => {
    ...
    Scene_Map.prototype.start = function() {
        ...
        switch (params['Location']) {
            case 'TOPRIGHT':
                locx = Graphics.boxWidth - Math.ceil(1920 / 1.57);
    ...
    Scene_Map.prototype.update = function() {
        ...
        switch (this.mapViewToggle) {
            case false:
                ...
                this.snapMinimapRender.transform.scale.x = 0.5;
                this.snapMinimapRender.transform.scale.y = 0.5;
                this.snapMinimapAct.transform.scale.x = 0.5;
                this.snapMinimapAct.transform.scale.y = 0.5;
                this.snapMinimapAct2.transform.scale.x = 0.5;
                this.snapMinimapAct2.transform.scale.y = 0.5;
                this.snapMinimapFowS.transform.scale.x = 0.5;
                this.snapMinimapFowS.transform.scale.y = 0.5;
                break;
            case true:
                this.snapMinimapRender.x = 2;
                this.snapMinimapRender.y = 2;
                this.snapMinimapRender.transform.scale.x = 3;
                this.snapMinimapRender.transform.scale.y = 3;
                this.snapMinimapAct.x = 2;
                this.snapMinimapAct.y = 2;
                ...
                this.snapMinimapFowS.x = 2;
                this.snapMinimapFowS.y = 2;
        ...
        if (Input.isTriggered('pagedown')) {
            $gameVariables.snapMapShow = !$gameVariables.snapMapShow;
        }
    }
